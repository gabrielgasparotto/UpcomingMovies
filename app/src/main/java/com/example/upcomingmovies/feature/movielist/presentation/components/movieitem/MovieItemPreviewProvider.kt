...
internal class MovieItemPreviewProvider : PreviewParameterProvider<MovieItemParams> {
    override val values = sequenceOf(
        MovieItemParams(
            movie = Movie(1, "Evil Dead Rise", "Two sisters find an ancient vinyl...", "2023-04-12", "/mIBCtPvKZQlxubxKMeViO2UrP3q.jpg", 7.0, 1234),
            onClick = {},
        ),
        MovieItemParams(
        ...
        MovieItemParams(
            movie = Movie(3, "Movie Without Poster", "No poster available.", "2023-05-17", null, 5.5, 321),
            onClick = {},
        ),
    )
}
